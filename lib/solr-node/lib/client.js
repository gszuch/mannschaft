 ...
 * Modified by Mannschaft Capstone project to work for our project
 */
...
var _ = require('underscore'),
  ...
  logger =  require('log4js').getLogger('solr-node'),
...
Client.prototype._requestGet = function(path, query, finalCallback) {
  ...
  requestFullPath = requestPrefixUrl + '?' + params + '&rows=1000';
